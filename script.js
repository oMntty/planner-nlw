...
const atividade = {
  nome: "Almoço",
  data: new Date("2024-07-08 10:00"), //Date é escrito ano/mês/dia daí hora
  finalizada: true
}
...
let atividades = [
  atividade,
  {
    ...
    data: new Date("2024-07-09 12:00"), //Date é escrito ano/mês/dia daí hora
    finalizada: false
  },
  {
    nome: "Gaming Session",
    data: new Date("2024-07-09 16:00"), //Date é escrito ano/mês/dia daí hora
    finalizada: true
  }
]
...
const atualizarListaDeAtividades = () => {
  ...
  for (let atividade of atividades) {
    //Processamento e apresentação do dado
